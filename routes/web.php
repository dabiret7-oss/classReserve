...
use App\Http\Controllers\Admin\CahierDeTexteController;
...
use App\Http\Controllers\Admin\CahierDeTexteController as AdminCahierController;
...
Route::prefix('professeur')->name('professeur.')->middleware(['auth', 'professeur'])->group(function () {
    ...
    Route::delete('/reservations/{reservation}/annuler',
    [ReservationController::class, 'annuler'])->name('reservations.annuler');
    Route::get('/cahiers', [CahierDeTexteController::class, 'index'])->name('cahiers.index');
    Route::get('/cahiers/{reservation}/create', [CahierDeTexteController::class, 'create'])->name('cahiers.create');
    Route::post('/cahiers/{reservation}', [CahierDeTexteController::class, 'store'])->name('cahiers.store');
